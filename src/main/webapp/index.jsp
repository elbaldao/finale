...
<div class="container-fluid">
	...
	<div id="jumbo" class="jumbotron">
	  ...
	  <p class="lead">Benvenuto nel nostra webpage. Qui potrai eseguire una serie di azioni su un testo, tra cui la traduzione, analizzarlo grazie al test dei tratti della personalit� dei Big 5, ottenere un file audio e molto altro.</p>
	  <hr class="my-4">
